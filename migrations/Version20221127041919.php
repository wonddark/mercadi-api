 ...
 */
final class Version20221127041919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD highest_bid_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer DROP highest_bid_id');
    }
}
